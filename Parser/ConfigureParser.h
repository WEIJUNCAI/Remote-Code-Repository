...
namespace CodeAnalysis
{
  ...
  private:
	...
	void build_BeginScope();
	void build_EndScope();
	void build_PreprocStatement();
	void build_NamespaceDefinition();
	void build_ClassDefinition();
	void build_EnumDefinition();
	void build_StructDefinition();
	void build_CppFunctionDefinition();
	void build_CSharpFunctionDefinition();
	void build_ControlDefinition();
	void build_CppDeclaration();
	void build_CSharpDeclaration();
	void build_CppExecutable();
	void build_CSharpExecutable();
	void build_Default();
