...
*  Maintanence History:
*  --------------------
*  ver 1.4 : 3 April 2017
*  - added dependency analysis, strongly connected components analysis
*  - added code publish function
*  ver 1.3 : 28 Oct 2016
...
namespace CodeAnalysis
{
  ...
  public:
	...
	////////////////////////////////////////////////
	void processCPP(bool showActivity);
	void processH(bool showActivity);
	void processCS(bool showActivity);
...
////////////////////////////////////////////////////////
	...
	StrongComponents SCs;
	CodePublisher publisher;

	std::vector<std::string> filesToPub;
	std::string publishPath = "PublishedFiles";
	std::string stylePath = "PublishedFiles/style.css";
	std::string jsPath = "PublishedFiles/collapse.js";
	std::string savePath = "../DependencyAnalyzeResult.txt";
  };
}
